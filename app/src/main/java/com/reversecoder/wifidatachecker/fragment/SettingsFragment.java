//package com.bjit.wifidatachecker.fragment;
//
...
//import com.bjit.wifidatachecker.R;
...
//        (ListPreference) findPreference("pref_key_measurement_unit");
//    notificationDrawerUnitOfMeasurePreference.setOnPreferenceChangeListener(
//        notificationDrawerUnitOfMeasurePreferenceListener);
//    notificationDrawerUnitOfMeasurePreference.setSummary(
//        notificationDrawerUnitOfMeasurePreference.getValue());
//
//    CheckBoxPreference showTotalValuePreference =
//        (CheckBoxPreference) findPreference("pref_key_show_total_value");
...
//    hideNotificationIconPreference.setOnPreferenceChangeListener(
//        hideNotificationIconPreferenceListener);
//
...
//  }
//
//  private final OnPreferenceChangeListener notificationDrawerUnitOfMeasurePreferenceListener =
...
//      };
//
//  private final OnPreferenceChangeListener showTotalValuePreferenceListener =
//      new OnPreferenceChangeListener() {
//        @Override public boolean onPreferenceChange(Preference preference, Object newValue) {
...
//      };
//
//  private final OnPreferenceChangeListener pollRatePreferenceListener =
//      new OnPreferenceChangeListener() {
//        @Override public boolean onPreferenceChange(Preference preference, Object newValue) {
//          ((ListPreference) preference).setValue(newValue.toString());
...
//
//          if (5 > pollValue) {
//            Toast.makeText(getActivity(), getString(R.string.poll_rate_warning), Toast.LENGTH_LONG)
//                .show();
//          }
//
//          restartService();
...
//      };
//
//  private final OnPreferenceChangeListener activeAppPreferenceListener =
//      new OnPreferenceChangeListener() {
//        @Override public boolean onPreferenceChange(Preference preference, Object newValue) {
...
//                getString(R.string.enable_active_app_feature_jelly_bean_mr2), Toast.LENGTH_LONG)
//                .show();
//          }
//          restartService();
//          return true;
...
//      };
//
//  private final OnPreferenceChangeListener hideNotificationIconPreferenceListener =
//      new OnPreferenceChangeListener() {
//        @Override public boolean onPreferenceChange(Preference preference, Object newValue) {
//          ((CheckBoxPreference) preference).setChecked((Boolean) newValue);
//          restartService();
...
//      };
//
//  private final OnPreferenceChangeListener disableCheckBoxPreferenceListener =
//      new OnPreferenceChangeListener() {
//        @Override public boolean onPreferenceChange(Preference preference, Object newValue) {
