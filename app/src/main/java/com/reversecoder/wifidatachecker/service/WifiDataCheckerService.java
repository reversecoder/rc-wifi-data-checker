...
//import com.reversecoder.wifidatachecker.widget.NetworkSpeedWidget;
//import com.reversecoder.wifidatachecker.model.WidgetSettings;
...
//    notificationEnabled = !(sharedPref.getBoolean("pref_key_auto_start", false));
    notificationEnabled = !SessionManager.getBooleanSetting(getApplicationContext(), AllConstants.SESSION_KEY_DISABLE_REPORTING_TO_NOTIFICATION,false);
        /*
...
//    hideNotification = sharedPref.getBoolean("pref_key_hide_notification", false);
    ...
    showTotalValueNotification = SessionManager.getBooleanSetting(getApplicationContext(),AllConstants.SESSION_KEY_SHOW_TOTAL_SPEED,false);
    ...
    hideNotification = SessionManager.getBooleanSetting(getApplicationContext(),AllConstants.SESSION_KEY_HIDE_NOTIFICATION_ICON,false);
